...
<body id="page-top">
 ...
 <br> <br> <br> <br> <br> <br> <br> <br>
		      ...
		      <br>
		       <div class="col-md-12">
	<center><h2 style="font-family:Montserrat; font-size: 30px;">Escolha o Tipo de blusa:</h2></center>
			</div>
		<br>
			<div class="row" style="margin-top: 60px;">
			<div class="col-md-2">
			<button style="background: transparent; border: transparent;"><img src="../img/mod.png"  id="img" style=" width: 80%;"> <h2 style="font-family:Montserrat; font-size: 20px; ">Branca</h2>
</button>
			    
</div>		
			<div class="col-md-2">
		
		<button style="background: transparent; border: transparent;"><img src="../img/mod2.png"  id="img" style=" width: 80%;" </button>
			<h2 style="font-family:Montserrat; font-size: 20px;">Colorida</h2>
			</div>
        </div> 
        <br> <br> <br> <br>
	<div class="col-md-2">
		<button style="background: transparent; border: transparent;"><img src="../img/barça.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Uniforme</h2></button>	
			
			</div>          
				<div class="col-md-2">  
				<button style="background: transparent; border: transparent;"><img src="../img/mod4.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Seila</h2></button>
	...
	<div class="row">
	<div class="col-md-4" >  
				<textarea style=" padding-right: 100px; margin-left: 100px; width: 700px; height: 300px; margin-top: -200px;"></textarea>
			</div>
	...
	<script type="text/javascript">
		...
		botao.addEventListener('click', function(){
			document.getElementById('img').src = "../img/mod2.png";
		});
	</script>
