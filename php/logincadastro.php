...
if($botao == "login"){
	...
	$insert = "INSERT INTO usuarios VALUES(0,'$nome','$sobrenome','$email','$senha','$cpf','$facebook','$whatsapp','$instagram');";
...
<body id="page-top">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div id="fundo" class="text-center" style="background-color: white; padding-left: 7%; padding-right: 7%; padding-top: 3%; padding-bottom: 3%; margin-top: 40%; border-radius: 4%;">
				<div class="row">
					...
					if(isset($_SESSION['msg'])){
						...
						<div class='row'></div>
						<div class='row'></div>
						<h3 style='color: red;'><b>".$_SESSION['msg']."</b></h3>
						";
						unset($_SESSION['msg']);
					}
					?>
		...
		<div class="col-md-6">
			<div id="fundo" class="text-center" style="background-color: white; padding-left: 7%; padding-right: 7%; padding-top: 3%; padding-bottom: 3%; margin-left: 4%; border-radius: 4%;">
				<div class="row">
					...
					<form class="col s12" method="post">
						<div class="row">
							...
							<div class="input-field col s6">
								...
								<input  id="cpf" type="text" class="validate" data-length="50" required OnKeyPress="formatar('###.###.###-##', this)" name="cpf" required></input>
								<label for="cpf" data-error="CPF inválido!">CPF</label>
								<span class="helper-text" data-error="CPF inválido"></span>
							</div>
							<div class="input-field col s6">
								<i class="far fa-envelope prefix"></i>
							...
							<div class="input-field col s3">
								<i class="fas fa-key prefix"></i>
								<input  id="rsenha2" type="password" class="validate" data-length="50" name="senha" required></input>
								<label for="rsenha2" data-error="Senha inválido!">Repita a senha</label>
								<span class="helper-text" data-error="Máximo: 50 caracteres"></span>
							</div>
					...
					if(isset($_SESSION['deu'])){
						...
						<div class='row'></div>
						<div class='row'></div>
						<h3 style='color: red;'><b>".$_SESSION['deu']."</b></h3>
						";
						unset($_SESSION['deu']);
					}
					?>
