	...
	<nav class="navbar navbar-default navbar-fixed-top" id="mainNav">
				...
				<div class="col-md-4	">
					<div  class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav pull-right" id="hover">
						  ...
						  <br>  <li role="presentation"><a href="login2.php" class="js-scroll-trigger" ><i class="fas fa-lock"></i>&nbsp Login</a> </li>    <li role="presentation"><a href="cds.php" class="js-scroll-trigger" ><i class="far fa-address-card"></i></i>&nbsp Cadastre-se</a> </li>
		...
		<section class="content-section content" style="padding-top: 5%; margin-bottom: 15%;">
			<div class="row">
				...
				<div class="col-md-3">
					<h1 class="text-center" style="font-family: Montserrat-light; font-weight: bold; font-weight: bold; color: #ff3578;">Redes sociais</h1>

					<button type="button" class="btn btn-primary edit" style="font-weight: 1000; padding-left: 38px; padding-right: 38px;"><i class="fab fa-facebook-f fa-3x"></i></button>
					<button type="button" class="btn btn-success edit" style="font-weight: 1000;"><i class="fab fa-whatsapp fa-3x"></i></button>
					<button type="button" class="btn btn-info edit" style="font-weight: 1000;"><i class="fab fa-instagram fa-3x" ></i></button>
				</div>
			</div>
		</section>


		<section id="produtos" class="content-section text-center" style="background-color: #ff3578; padding: 50px; color: white;">

			<BR>
			<h1 class="text-center" style="font-family: Montserrat-light; font-weight: bold; color: white;"><i class="fas fa-box-open"></i> FAÇA A SUA ENCOMENDA</h1>
			<hr width="20%" style=" background-color: white; height: 2px; border: 0;">
			<BR><BR>
			...
			<div class="row">	
				...
				<div class="col-md-4">
					<div class="">
						...
						<div class="carousel pull-right">
							<a class="carousel-item" href="#one!"><img src="img/p/p10.jpg"></a>
							<a class="carousel-item" href="#two!"><img src="img/p/p1.jpg"></a>
							<a class="carousel-item" href="#three!"><img src="img/p/p2.jpg"></a>
							<a class="carousel-item" href="#four!"><img src="img/p/p3.jpg"></a>
							<a class="carousel-item" href="#five!"><img src="img/p/p4.jpg"></a>
							<a class="carousel-item" href="#six!"><img src="img/p/p5.jpg"></a>
							<a class="carousel-item" href="#seven!"><img src="img/p/p6.jpg"></a>
							<a class="carousel-item" href="#eight!"><img src="img/p/p7.jpg"></a>
							<a class="carousel-item" href="#nine!"><img src="img/p/p8.jpg"></a>
						</div>
						<button type="button" class="btn i9 btn-lg" style="font-weight: 1000;">PERSONALIZE SUA BLUSA</button>
				...
				<div class="col-md-4">
					<div class="">
						<h1>Canecos</h1>
						<div class="carousel pull-right">
							<a class="carousel-item" href="#ten!"><img src="img/p/c1.jpg"></a>
							<a class="carousel-item" href="#ten!"><img src="img/p/c2.jpg"></a>
							<a class="carousel-item" href="#ten!"><img src="img/p/c3.jpg"></a>
							<a class="carousel-item" href="#ten!"><img src="img/p/c4.jpg"></a>
							<a class="carousel-item" href="#ten!"><img src="img/p/c5.jpg"></a>
							<a class="carousel-item" href="#ten!"><img src="img/p/c6.jpg"></a>
						</div>						
						<button type="button" class="btn i9 btn-lg" style="font-weight: 1000;">PERSONALIZE SEU CANECO</button>
					</div>	
				</div>
				<div class="col-md-1"></div>
