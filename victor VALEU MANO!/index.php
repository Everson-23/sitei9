...
<body id="page-top">
				...
				<div  class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav pull-right" id="hover">
						...
						if(isset($_SESSION['nome'])){
							...
							<li role='presentation'><a type='button' class='modal-trigger' data-target='".$msg."' href=''><i class='fas fa-comments'></i></i>&nbsp Mensagens</a></li>
	...
	<section class="content-section content" style="padding-top: 15%; margin-bottom: 15%;" id="sobre">
		<div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-4" style="padding-left: 30px;">
				...
				<p class="lead" style="font-size: 20px; font-family: Montserrat-light;">O Lorem Ipsum é um texto modelo da indústria tipográfica e de impressão. O Lorem Ipsum tem vindo a ser o texto padrão usado por estas indústrias desde o ano de 1500, quando uma misturou os caracteres de um texto para criar um espécime de livro.s</p>
			</div>
			<div class="col-md-1"></div>
			<div class="col-md-3" style="background-color: white; box-shadow: 5px 5px  #d9e7f4">

				<a type="button" class="btn btn-primary edit" style="font-weight: 1000; padding-left: 38px; padding-right: 38px;" href="https://www.facebook.com/I9-Conceitos-1790436684620481/"><i class="fab fa-facebook-f fa-3x"></i></a>
				<font style="font-family: Montserrat-light; font-weight: bold; color: #3965c2; font-size: 1.7em;">&nbsp&nbsp /I9-Conceitos</font><br>

				<a type="button" class="btn btn-success edit" style="font-weight: 1000;"><i class="fab fa-whatsapp fa-3x"></i></a>
				<font style="font-family: Montserrat-light; font-weight: bold; color: #34af23; font-size: 1.7em;">&nbsp&nbsp (85) 986170949</font>
				<br>

				<a type="button" class="btn btn-info edit" style="font-weight: 1000;" href="https://www.instagram.com/i9conceitos"><i class="fab fa-instagram fa-3x" ></i></a>
	...
	<section id="produtos" class="content-section text-center" style="background-image: url(img/fundobaixp.png); background-repeat: no-repeat;  font-family: Century Gothic; width: 100%;">
		  	...
		  	<div style="display: flex; justify-content: center; align-items: center; background-color: white;" >
			    ...
			    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
			      	<div class="panel-body">
			      		<form method="post" action="php/blusas.php">
					      	<div class="row">
								<div class="col-md-12" id="as">
									<div class="carousel" id="cblusa">
										<a href="blusas.php" class="carousel-item" href="#one!"><img src="img/p/m1.png"></a>
										<a href="blusas.php" class="carousel-item" href="#two!"><img src="img/p/m2.png"></a>
										<a href="blusas.php" class="carousel-item" href="#four!"><img src="img/p/m3.png"></a>
										<a href="blusas.php" class="carousel-item" href="#six!"><img src="img/p/m4.png"></a>
										<a href="blusas.php" class="carousel-item" href="#eight!"><img src="img/p/m5.png"></a>
										<a href="blusas.php" class="carousel-item" href="#nine!"><img src="img/p/m6.png"></a>
										<a href="blusas.php" class="carousel-item" href="#six!"><img src="img/p/m7.png"></a>
										<a href="blusas.php" class="carousel-item" href="#six!"><img src="img/p/m8.png"></a>
										<a href="blusas.php" class="carousel-item" href="#six!"><img src="img/p/m9.png"></a>
									</div>
								</div>
							</div>
							</Br>
									...
									<div class="col-md-4">
										<?php 
											if(isset($_SESSION['email'])){	
												echo "<button type='submit' style='width: 70%;' class='btn-i9 btn-lg' >PERSONALIZAR</button>";
											}else{
												echo "<button type='button' style='width: 70%;' class='btn-i9 btn-lg'>FAÇA O LOGIN PARA PERSONALIZAR</button>";
											}
										?>
									</div>
								<div class="col-md-4"></div>
			    ...
			    <div id="collapseTwo" class="panel-collapse collapsing" role="tabpanel" aria-labelledby="headingTwo">
			      <div class="panel-body">
			      		<form method="post" action="php/copos.php">
					      	<div class="row">
								<div class="col-md-12" id="as">
									<div class="carousel" id="cblusa">
										<a href="copos.php" class="carousel-item" href="#one!"><img src="img/p/c1.png"></a>
										<a href="copos.php" class="carousel-item" href="#two!"><img src="img/p/c2.png"></a>
										<a href="copos.php" class="carousel-item" href="#four!"><img src="img/p/c3.png"></a>
										<a href="copos.php" class="carousel-item" href="#six!"><img src="img/p/c4.png"></a>
										<a href="copos.php" class="carousel-item" href="#eight!"><img src="img/p/c5.png"></a>
										<a href="copos.php" class="carousel-item" href="#nine!"><img src="img/p/c6.png"></a>
										<a href="copos.php" class="carousel-item" href="#six!"><img src="img/p/c3.png"></a>
										<a href="copos.php" class="carousel-item" href="#six!"><img src="img/p/c4.png"></a>
										<a href="copos.php" class="carousel-item" href="#six!"><img src="img/p/c5.png"></a>
									</div>
								</div>
							</div>
							</Br>
			    ...
			    <div id="collapseThree" class="panel-collapse collapsing" role="tabpanel" aria-labelledby="headingThree">
			      <div class="panel-body">
			      		<form method="post" action="php/baldes.php">
					      	<div class="row">
								<div class="col-md-12" id="as">
									<div class="carousel" id="cblusa">
										<a href="baldes.php" class="carousel-item" href="#one!"><img src="img/p/b1.png"></a>
										<a href="baldes.php"  class="carousel-item" href="#two!"><img src="img/p/b2.png"></a>
										<a href= "baldes.php" class="carousel-item" href="#four!"><img src="img/p/b3.png"></a>
										<a href="baldes.php" class="carousel-item" href="#six!"><img src="img/p/b1.png"></a>
										<a href="baldes.php" class="carousel-item" href="#eight!"><img src="img/p/b1.png"></a>
										<a href="baldes.php" class="carousel-item" href="#nine!"><img src="img/p/b1.png"></a>
										<a href="baldes.php" class="carousel-item" href="#six!"><img src="img/p/b1.png"></a>
										<a href="baldes.php" class="carousel-item" href="#six!"><img src="img/p/b1.png"></a>
										<a href="baldes.php" class="carousel-item" href="#six!"><img src="img/p/b1.png"></a>
									</div>
			    ...
			    <div id="collapseFour" class="panel-collapse collapsing" role="tabpanel" aria-labelledby="headingFour">
			      <div class="panel-body">
			      		<form method="post" action="php/lmofadas.php">
					      	<div class="row">
								<div class="col-md-12" id="as">
									<div class="carousel" id="cblusa">
										<a href="almofadas.php" class="carousel-item" href="#one!"><img src="img/p/a1.png"></a>
										<a  href= "almofadas.php" class="carousel-item" href="#two!"><img src="img/p/a1.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#four!"><img src="img/p/a3.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#six!"><img src="img/p/a4.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#eight!"><img src="img/p/a5.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#nine!"><img src="img/p/a6.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#six!"><img src="img/p/a7.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#six!"><img src="img/p/a8.png"></a>
										<a href="almofadas.php" class="carousel-item" href="#six!"><img src="img/p/a5.png"></a>
									</div>
								</div>
							</div>
							</Br>
	...
	<footer style="margin-top: 200px; color: white; padding: 50px; text-align: center;">
		<div class="row">
			<div class="col-md-4" style="border-right: 1px solid white;">
				<h3>EQUIPE DE DESENVOLVIMENTO</h3>
				Victor Magalhães Sales<br>
				Everson Baitola da Viada<br>
				Josy esqueci o resto<br>
				Camila Camelo<br>
				Shelda Coreógrafa<br>
				Estefane no crossfox
			</div>
			<div class="col-md-8" style="padding-top: 3%;">
				<h4>©2018 Copyright <font color="#ff3578">i9 Conceitos</font></h4>
	...
	<div id="modal1" class="modal" style="font-family:Montserrat; width: 40%;">
		<a type="button"  class="modal-action modal-close pull-right" style="margin: 2%;"><i class="fas fa-times fa-2x"> </i> </a>
		<div class="row" style="margin: 7%;">
			...
			<form class="col s12" method="post" action="php/logincadastro.php">
				...
				<button type="submit" class="btn-i9 pull-left" style="width: 100%;" name="botao" value="login">LOGIN</button>
			</form>	
	...
	<div id="cadastro" class="modal " style="font-family:Montserrat; width: 60%;">
		...
		<div class="row" style="margin-left: 4%; margin-right: 4%; margin-top: 2%;">
			...
			<form class="col s12" method="post" action="php/logincadastro.php">
				...
				<button type="submit" class="btn-i9" style="width: 100%;" name="botao" value="registrar">CADASTRAR</button>
			</form>
	...
	<div id="mensagens" class="modal modal-fixed-footer" style="font-family:Montserrat; width: 85%; height: 1000px;overflow-x: hidden; ">
		<a type="button"  class="modal-action modal-close pull-right" style="margin: 2%;"><i class="fas fa-times fa-2x"></i> </a>
		<div class="modal-content">
			...
			<div class="chat">
				...
				<div class="col s6">
					<ul>
						<li class="you">
							<a class="user" href="#"><img alt="" src="img/otavio.jpg" /></a>
							<div class="date">
							</div>
							<div class="message">
								<div class="hider">
		...
		<form method="post" action="pro2.php" id="meufrm">

				<div class="input-field">
		            <textarea id="mensagem" class="materialize-textarea" data-length="200"  name="mensagem" style="width: 92%;"></textarea>
		            <label for="mensagem">Mensagem</label>
		            <button class="btn-i9"  type="submit">Enviar</button>
	...
	<div id="mensagensadm" class="modal" style="font-family:Montserrat; width: 40%;">
		<a type="button"  class="modal-action modal-close pull-right" style="margin: 2%;"><i class="fas fa-times fa-2x"></i> </a>
		<div class="row" style="margin: 7%;">
			<h4 align="center" style="font-size: 2em;">Mensagens</h4><br>
					    ...
					    <ul>
					      <li class="other">
					        ...
					        <div class="message">
					          ...
					          <p>
					           asdasdadaddddddd dddddd dddddddaaaaaaaaaaa aaaaaaaaaaaaa aaaaaaaaaaaaaa aaaaa ddddddddddddasd
					          </p>
					        </div>
					      </li>
					      <li class="other">
					        ...
					        <div class="message">
					          ...
					          <p>
					           asdasdadadddddddddd dddddd ddddaaaaaaa aaaaaaaaaa aaaa aaaaaaaa aaaaaaaaaaaaaa ddddddddd dddasd
					          </p>
					        </div>
					      </li>
					      <li class="you">
					        ...
					        <div class="message">
					          ...
					          <p>
					           asdasdadaddddddd ddddddddddd daaaaaaaaaaaa aaaaaaaaaaaaaa aaaaaaaaaaaaaaaaa ddddddd ddasd
					          </p>
					        </div>
					      </li>
					      <li class="other">
					        ...
					        <div class="message">
					          ...
					          <p>
					            asdasdadaddd ddddddddddddd ddddaaaaaaa aaaaaaaaaa aaaaaaaaaaaaaa aaaaaaaaaaa adddddddd ddddasd
					          </p>
					        </div>
					      </li>
					</div>      
