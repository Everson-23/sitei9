...
<body id="page-top">
	...
	<!-- ----------------------------------- LOGO I9 CONCEITOS ----------------------------------- -->
		...
		<br> 	<br>	<br>	<br>	<br>   
		<div class="col-md-12">
	<center><h2 style="font-family:Montserrat; font-size: 30px; margin-top: 30px;">Escolha o Tipo de balde:</h2></center>
			</div>
			<div class="row" style="margin-top: 70px;"> 
			<div class="col-md-2">
			<button style="background: transparent; border: transparent;"><img src="img/p/b3.png"  id="img" style=" width: 80%;"> <h2 style="font-family:Montserrat; font-size: 20px; ">Pipoca</h2>
</button>
			   
</div>		
			<div class="col-md-2">
		
		<button style="background: transparent; border: transparent;"><img src="img/p/b2.png"  id="img" style=" width: 80%;" </button>
			<h2 style="font-family:Montserrat; font-size: 20px;">Kids</h2>
			</div>
        </div> 
        <br> <br> <br> <br>
	<div class="col-md-2">
		<button style="background: transparent; border: transparent;"><img src="img/p/b1.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Balde de gelo</h2></button>	
			
			</div>          
				<div class="col-md-2">  
				<button style="background: transparent; border: transparent;"><img src="img/p/b4.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Comum</h2></button>
