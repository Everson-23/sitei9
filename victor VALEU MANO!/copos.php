...
<body id="page-top">
	...
	<!-- ----------------------------------- LOGO I9 CONCEITOS ----------------------------------- -->
		...
		<br> 	<br>	<br>	<br>	<br>   
		<div class="col-md-12">
	<center><h2 style="font-family:Montserrat; font-size: 30px; margin-top: 30px;">Escolha o Tipo de copo:</h2></center>
			</div>
			<div class="row" style="margin-top: 70px;"> 
			<div class="col-md-2">
			<button style="background: transparent; border: transparent;"><img src="img/p/c3.png"  id="img" style=" width: 80%;"> <h2 style="font-family:Montserrat; font-size: 20px; ">Com desenho</h2>
</button>
			   
</div>		
			<div class="col-md-2">
		
		<button style="background: transparent; border: transparent;"><img src="img/p/c6.png"  id="img" style=" width: 80%;" </button>
			<h2 style="font-family:Montserrat; font-size: 20px;">Twister colorido</h2>
			</div>
        </div> 
        <br> <br> <br> <br>
	<div class="col-md-2">
		<button style="background: transparent; border: transparent;"><img src="img/p/c5.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Twister Branco
		</h2></button>	
			
			</div>          
				<div class="col-md-2">  
				<button style="background: transparent; border: transparent;"><img src="img/p/c1.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Long Drink</h2></button>
