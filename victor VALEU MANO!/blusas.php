...
<body id="page-top">
	...
	<!-- ----------------------------------- LOGO I9 CONCEITOS ----------------------------------- -->
		...
		<br> 	<br>	<br>	<br>	<br>   
		<div class="col-md-12">
	<center><h2 style="font-family:Montserrat; font-size: 30px; margin-top: 30px;">Escolha o Tipo de blusa:</h2></center>
			</div>
			<div class="row" style="margin-top: 70px;"> 
			<div class="col-md-2">
			<button style="background: transparent; border: transparent;"><img src="mod.png"  id="img" style=" width: 80%;"> <h2 style="font-family:Montserrat; font-size: 20px; ">Branca</h2>
</button>
			   
</div>		
			<div class="col-md-2">
		
		<button style="background: transparent; border: transparent;"><img src="mod2.png"  id="img" style=" width: 80%;" </button>
			<h2 style="font-family:Montserrat; font-size: 20px;">Colorida</h2>
			</div>
        </div> 
        <br> <br> <br> <br>
	<div class="col-md-2">
		<button style="background: transparent; border: transparent;"><img src="barça.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Uniforme</h2></button>	
			
			</div>          
				<div class="col-md-2">  
				<button style="background: transparent; border: transparent;"><img src="mod4.png"  id="img" style=" width: 80%;"><h2 style="font-family:Montserrat; font-size: 20px;">Seila</h2></button>
