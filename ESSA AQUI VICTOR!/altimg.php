...
<body id="page-top">
	...
	<div class="img" style="background-color: white; margin-top: 7%; margin-left: 7%; margin-right: 7%; padding: 5%;">
		<div style='display: flex; justify-content: center;  align-items: center;'><img src="<?php
			 echo $novo_nome; ?>" class="circle" style="width: 30%;"></div>
		<form>
			<center>
			<h4><input type="file" name="img"></h4>
			<br><br>
