...
<body id="page-top">
	...
	<div class="perfil" style="background-color: white; margin: 10%; padding-top: 2%;">
		<h1 align="center">Meu perfil</h1>
		<h4 align="center"><a type='button' class='modal-trigger' data-target='modal1' href=''><i class="fas fa-edit"></i>&nbsp EDITAR</a></h4>
		<hr style="background-color: black;">
		<div class="row">
			<div class="col-md-3">
				<form action = perfilusuario.php method="POST" enctype = "multipart/form-data"><?php 
				$msg = false;
				if(isset($_SESSION['imagem'])){
						echo "IMG dele";
						$ext = strtolower(substr($_SESSION['imagem'], -4));
					...
					$sql_code = "INSERT INTO imagens(codigo,arquivo,data)VALUES(NULL,'$novo_nome',NOW())";
					  if(($mysqli->query($sql_code))){
						  $msg = "Foto Modificada com sucesso!";  
						  	echo "<div style='display: flex; justify-content: center;  align-items: center;'><img src=$novo_nome class='circle' style='width: 80%;'></div>";
						  
					  }else{
							  $msg = "Falha ao modificar a foto!";
						  }
						 
					  
					}else{
						echo "<div style='display: flex; justify-content: center;  align-items: center;'><img src=' class='circle' style='width: 80%;'></div>";
					}
				?></form><br>
				<h4 align="center"><a href="altimg.php">Alterar imagem</a></h4> 
				<br>
				<h4 align="center"><a href="altsenha.php">Alterar senha</a></h4> 
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
				<h3><i class="fab fa-facebook"></i> Facebook: </h3><?php echo $_SESSION['facebook']; ?>
				<h3><i class="fab fa-whatsapp"></i> Whatsapp: </h3><?php echo $_SESSION['whatsapp']; ?>
				<h3><i class="fab fa-instagram"></i> Instagram: </h3><?php echo $_SESSION['instagram']; ?>
			</div>
			<div class="col-md-3">
...
<div class="col s10 offset-s1">
				<h1 align="center">Mensagens dos usuários</h1><Br>
		<table class="table table-hover table-bordered">
			...
			<?php 
							include_once("conexao.php");
							$conver = "SELECT conversa_adm FROM conversa";
							$li = mysqli_query($conn, $conver);
						 	while($infor = mysqli_fetch_assoc($li)){
						?>		

						<tr>
							
							<td><?php echo $infor['conversa_adm']; ?></td>
						</tr>
						<?php } ?>
      ...
      <label for="email">
       ...
       <input type="email" placeholder="Digite o seu E-mail" name="email">
		   ...
		   <label for="redes">
       redes sociais
       <input type="email" placeholder="Digite as suas redes" name="redes">
     </label><br><br>
		<form>
...
$ms = "INSERT INTO conversa(nome,email,redes_sociais,conversa_cliente) VALUES('$nome','$email','$redes','$mensagem');";
	$ms = mysqli_query($conn,$ms);
	if($ms){
			$_SESSION['deu']="mensagem enviada com sucesso";
		}else{
			$_SESSION['deu']="não enviou";
		}
?>
 <button  type="submit" class="btn-i9" name="enviar">Enviar Pra puta que pariu!!</button>
		</form>
	</div>
