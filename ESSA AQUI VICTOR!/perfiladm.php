...
<body id="page-top">
	...
	<div class="perfil" style="background-color: white; margin: 7%; padding-top: 2%; padding-bottom: 2%;">
			...
			<div class="col-md-3">
				<?php 
					if(isset($_SESSION['imagem'])){
						...
						echo "<div style='display: flex; justify-content: center;  align-items: center;'><img src='../img/otavio.jpg' class='circle' style='width: 80%;'></div>";
					}
				?><br>
		...
		<div class="row">
			<div class="col s1 offset-s6">
				<a href="#historico" class="btn btn-circle js-scroll-trigger" style="color: #e43f77;">
	...
	<div id="historico" style="padding-top: 5%;">
		<div class="row">
			<div class="col s10 offset-s1">
				...
				<table class="table table-hover table-bordered">
					<thead>
						<tr>
							<th colspan="8" style="text-align: center;"><h3>Informações do cliente</h3></th><th colspan="3" style="text-align: center;"><h3>Informações do pedido</h3></th>
						</tr>	
						<tr>
							<th>Nome</th>
							<th>Email</th>
	...
	<div class="usuarios">
		...
		<table class="table table-hover table-bordered">
			...
			<?php 
							include_once("conexao.php");
							$conver = "SELECT * FROM conversa";
							$li = mysqli_query($conn, $conver);
						 	while($infor = mysqli_fetch_assoc($li)){
						?>		

						<tr>
							<td><?php echo $infor['nome']; ?></td>
							<td><?php echo $infor['email']; ?></td>
							<td><?php echo $infor['redes_sociais']; ?></td>
							<td><?php echo $infor['conversa_cliente']; ?></td>
						</tr>
						<?php } ?>
...
$ms = "INSERT INTO conversa(conversa_adm) VALUES('$mensagem');";
