...
<body id="page-top">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div id="fundo" class="text-center" style="background-color: white; padding-left: 7%; padding-right: 7%; padding-top: 3%; padding-bottom: 0.3%; margin-left: 4%; border-radius: 4%;">
				<div class="row">
