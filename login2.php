					...
					<div  class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav pull-right" id="hover">
							...
							<li role="presentation"> <a href="#produtos" class="js-scroll-trigger" ><i class="fas fa-shopping-basket fa-1x"></i>&nbsp PRODUTOS</a> </li>
							 <li role="presentation"><a href="cds.php" class="js-scroll-trigger" ><i class="far fa-address-card"></i></i>&nbsp Cadastre-se</a> </li>
...
<form method="POST" action="validar.php">
	...
	<div class="col-sm-2"> 
		<label for="inputPassword3" class="col-sm-2 control-label">Senha</label> <br>
   <input type="Password" class="form-control" id="inputPassword3" placeholder="Senha" name="senha"> 
<br><br><br>                 <input type="submit" class="btn i9 btn-lg" name="btenviar" value="Entrar">
	</div>
